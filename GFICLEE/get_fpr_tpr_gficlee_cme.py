...
foo.write_tpr_fpr(all_tpr_fpr_precision,
                  '/home/yangfang/GFICLEE/test_cme_gficlee/cme_tpr_fpr_precision_gficlee.txt')
foo.write_all(all_r,
              '/home/yangfang/GFICLEE/test_cme_gficlee/cme_tp_fp_tn_fn_gficlee.txt')
