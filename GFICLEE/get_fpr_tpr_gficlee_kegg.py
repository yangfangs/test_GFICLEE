...
def trans_gficlee(input_path, out_path,name):
...
trans_gficlee('/home/yangfang/GFICLEE/test_kegg/result_all/',
            '/home/yangfang/GFICLEE/test_kegg/result_all_trans/',
            'Gene Symbol')
...
foo = PlotRoc('/home/yangfang/GFICLEE/test_kegg/input/',
              '/home/yangfang/GFICLEE/test_kegg/output/',
...
foo.write_tpr_fpr(all_tpr_fpr_precision,
                  '/home/yangfang/GFICLEE/test_kegg/kegg_tpr_fpr_precision_clime.txt')
foo.write_all(all_r,
              '/home/yangfang/GFICLEE/test_kegg/kegg_tp_fp_tn_fn_clime.txt')
